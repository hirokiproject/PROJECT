...
<!-- =========================
    Spesifikasi
============================== -->
<section id="spesifikasi" class="parallax-section">
	<div class="container">
		<?php
			$id = $_GET['id'];
			//echo "id = $id";
			include '../koneksi.php';
			$tampil = "select * from news where id=$id";
			...
			<div class='row'>
				<div class='wow fadeInLeft col-md-12 col-sm-12' data-wow-delay='0.3s'>
					<div class='gambarNews01'>
						<img src='../HP/production/images/news/$data[4]' alt='news01'>
					</div>
				</div>
			</div>
			<div class='row'>
				<div class='wow fadeInRight col-md-12 col-sm-12' data-wow-delay='0.3s'>
					<div class='tanggalNews01'>
						<span class='glyphicon glyphicon-calendar' aria-hidden='true'>&nbsp;$data[1]</span>
					</div>
				</div>
			</div>
			<div class='row'>
				<div class='wow fadeInRight col-md-12 col-sm-12' data-wow-delay='0.5s'>
					<div class='keteranganNews01'>
						<p>".str_replace("\r\n", "<br>", $data[3])."</p>
					</div>
				</div>
			</div>
		...
		<div class="wow fadeInUp col-md-12 col-sm-12" data-wow-delay="0.3s">
			<div class="row">
				<div class="kumpulanBerita">
					<?php
		              include '../koneksi.php';
		              $tampil = "select * from news order by tanggal DESC LIMIT 3";
		              $hasil = mysqli_query($koneksi,$tampil);
		              while($data = mysqli_fetch_array($hasil)){
					  $kalimat = $data[3];

...
<div class="gambarHeaderServis">
	<img src="../images/bookingService/bookingService.jpg" class="img-responsive" alt="Booking Service" width="100%">
</div>
					...
					<div>
						<form class="form-horizontal" action="input.php" method="post">
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-9">
						      <input type=time min=8:00 max=16:00 step=1800 name="jam" required>
						    </div>
						  </div>
						  <div class="form-group">
						  ...
						  <div class="form-group">
						    <label class="col-sm-3 control-label">Kerusakan / Keluhan</label>
						    <div class="col-sm-9">
						    	<textarea rows="5" class="form-control" name="kerusakan" required></textarea>
						    </div>
						  </div>
						  <div class="form-group">

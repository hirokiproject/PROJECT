            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <input class="form-control" id="myInput" type="text" placeholder="Search" style="border-radius:4px; margin-bottom: 15px;">
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <?php
                          include '../../koneksi.php';
                          $tampil = "select * from suaraPelanggan where status in('Unapprove')";
                          ...
                          while($data = mysqli_fetch_row($hasil)){
                            echo"<tr>
                              ...
                              <td>$data[9]</td>
                              <td>$data[10]</td>
                              <td><a class='btn btn-success' role='button' href=\"editSuaraPelanggan.php?id=$data[0]\">Approve</td>
                              </tr>";
                              $no++;
                          }

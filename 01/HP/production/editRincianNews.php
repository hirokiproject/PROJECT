                  ...
                  <div class="x_content">
                    <?php
                      ...
                      while($data = mysqli_fetch_array($hasil)){
                        echo"
                        <form method='POST' action='SimpanRincianNews.php' enctype='multipart/form-data'>
                          <div class='form-group'>
                            <label>Judul</label>
                            <input type='text' name='judul' class='form-control' value='$data[2]'>
                          </div>
                          <div class='form-group'>
                            <label>Tanggal</label>
                            <input type='date' name='tanggal' class='form-control' value='$data[1]'>
                          </div>
                          <div class='form-group'>
                            <label>Keterangan</label>
                            <textarea class='form-control' name='keterangan' rows='5'>$data[3]</textarea>
                          </div>
                          <div class='form-group'>

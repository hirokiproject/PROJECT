                  ...
                  <div class="x_content">
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <?php
                          include '../../koneksi.php';
                          $tampil = "select * from bookingService where status in('Belum Dikerjakan')";
                          ...
                          while($data = mysqli_fetch_row($hasil)){
                            echo"<tr>
                              ...
                              <td>$data[8]</td>
                              <td>$data[9]</td>
                              <td><a class='btn btn-success' role='button' href=\"editBookingService.php?id=$data[0]\">Selesai</td>
                              </tr>";
                              $no++;
                          }

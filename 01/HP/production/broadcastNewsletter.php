            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form method="post" action="kirimEmailBroadcast.php">
                      <div class="form-group">
                        <label>Subject</label>
                        <input type="text" class="form-control" name="mail_subject" placeholder="Masukkan Subject ">
                      </div>
                      <div class="form-group">
                        <label>Isi</label>
                        <textarea class="ckeditor" id="ckedtor" name="mail_body"></textarea>
                      </div>
                      <div class="form-group">
                        <label>List Email</label>
                        <textarea rows="5" class="form-control" name="email_list"><?php  
                        include '../../koneksi.php';
                        $tampil = "select * from newsletter";
